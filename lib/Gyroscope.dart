...
class GyroTestScreen extends StatefulWidget {
  @override
  _GyroTestScreenState createState() => _GyroTestScreenState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: const Color.fromARGB(255, 57, 162, 248),
      ),
      body: Center(
          child: Column(
        children: [
          ...
          Container(
            ...
            child: const Center(child: Text("Bottom Box - Fixed Height")),
          ),
        ],
      )),
    );
